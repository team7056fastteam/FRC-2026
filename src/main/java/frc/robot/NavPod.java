...
class NavPodUpdate
{
    ...
    public double   gx;     // x gravity vector
    public double   gy;     // y gravity vector
    public double   gz;     // z gravity vector
}
...
public class NavPod extends Thread
{
    ...
    NavPodUpdate getUpdate()
    {
        ...
        update.gx = reply.containsKey("GX") ? Double.parseDouble(reply.get("GX")) : 0;
        update.gy = reply.containsKey("GY") ? Double.parseDouble(reply.get("GY")) : 0;
        update.gz = reply.containsKey("GZ") ? Double.parseDouble(reply.get("GZ")) : 0;
        return update;
    }
